...
lines(a,as.numeric(du[6,-1])/as.numeric(du[2,-1]) ,type="l",lty="dotted" )
...
plot(a,as.numeric(du[4,-1])/as.numeric(du[3,-1]), main=RE_3,
     ylim=c(0,1.5),type="l", lty="solid", xlab="Degree of heteroscedasticity",ylab="Relative efficiency",cex.lab=2,cex.axis=2,cex.main=1.5)
lines(a, b,type="l",ylim=c(0,1 ), lty="dashed")


plot(a,as.numeric(du[6,-1])/as.numeric(du[5,-1]),main=RE_4,
     ylim=c(0,1.5),type="l", lty="solid", xlab="Degree of heteroscedasticity",ylab="Relative efficiency",cex.lab=2,cex.axis=2,cex.main=1.5)
lines(a, b,type="l",ylim=c(0,1 ), lty="dashed")
